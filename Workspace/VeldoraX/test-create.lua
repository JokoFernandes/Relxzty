...
if not isfolder("LIUDEX Z") then
	makefolder("LIUDEX Z")
	makefolder("LIUDEX Z/Auto Execute")
	makefolder("LIUDEX Z/Data")
end
...
local function createdropdown(ui,name,table)
...
--Variable
	...
	local VIManager = game:GetService("VirtualInputManager")
...
local function toggleFreecam()
	...
	af.Visible = freecamEnabled
	af.Position = UDim2.new(0.08,0,0.6,0)
	if clossed then
...
UIS.InputBegan:Connect(function(Input, gp)
	...
	if Input.UserInputType == Enum.UserInputType.MouseButton2 or Input.UserInputType == Enum.UserInputType.Touch and not gp then
		rotating = true
	end
end)
...
local function changeMaterial(container, newMaterial, decalid)
    for _, child in ipairs(container:GetDescendants()) do
        if child:IsA("BasePart") or child:IsA("MeshPart") then
            child.Material = newMaterial
            local res = decalid or getcustomasset("base.png") or "rbxassetid://126569944133822"
...
local config = {}
local buttonTable = {}
local function newButton(tbl, text, parentTo, callback)
	local mtable = tbl
	local newButtons = gui("TextButton", text, mtable.Background, mtable.Text, parentTo, mtable.Radius, mtable.Transparency)

	newButtons.Size = mtable.Size

	if callback then
		newButtons.MouseButton1Click:Connect(callback)
	end
...
icon.Image = "rbxassetid://126569944133822" 
...
local function SetIcon(obj,assetId)
...
local arrowColor = Color3.fromRGB(0,0,0)
local arrowFrame  = gui("Frame","ArrowFrame",arrowColor,"",screenGui,100,0)
arrowFrame.Visible = freecamEnabled
arrowFrame.Position = UDim2.new(0.08,0,0.6,0)
arrowFrame.Size = UDim2.new(0,40,0,40)
af = arrowFrame
local arrowUp = gui("TextButton","arrowUp",backgroundColor,"W",arrowFrame,5,0)
arrowUp.Position = UDim2.new(0.11,0,-0.84,0)
arrowUp.Size = UDim2.new(0,30,0,30)
arrowUp.InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		keypress(Enum.KeyCode.W)
	end
end)
arrowUp.InputEnded:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		keyrelease(Enum.KeyCode.W)
	end
end)
local arrowDown = gui("TextButton","arrowDown",backgroundColor,"S",arrowFrame,5,0)
arrowDown.Position = UDim2.new(0.11,0,1.1,0)
arrowDown.Size = UDim2.new(0,30,0,30)
arrowDown.InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		keypress(Enum.KeyCode.S)
	end
end)
arrowDown.InputEnded:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		keyrelease(Enum.KeyCode.S)
	end
end)
local arrowLeft = gui("TextButton","arrowLeft",backgroundColor,"A",arrowFrame,5,0)
arrowLeft.Position = UDim2.new(-0.84,0,0.1,0)
arrowLeft.Size = UDim2.new(0,30,0,30)
arrowLeft.InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		keypress(Enum.KeyCode.A)
	end
end)
arrowLeft.InputEnded:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		keyrelease(Enum.KeyCode.A)
	end
end)
local arrowRight = gui("TextButton","arrowRight",backgroundColor,"D",arrowFrame,5,0)
arrowRight.Position = UDim2.new(1.09,0,0.108,0)
arrowRight.Size = UDim2.new(0,30,0,30)
arrowRight.InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		keypress(Enum.KeyCode.D)
	end
end)
arrowRight.InputEnded:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		keyrelease(Enum.KeyCode.D)
	end
end)

makeDraggable(arrowFrame)
...
rightPanel.Position = UDim2.new(0,200,0,50)
...
decalId.Text = ""
decalId.PlaceholderText = "Decal Id ..."
...
decalSpam.MouseButton1Click:Connect(function()
	local dec = "rbxassetid://" .. decalId.Text
	changeMaterial(game.Workspace, Enum.Material.Neon, dec)
end)
...
Misc.Visible = false
local MiscLayout = createLayout(Misc,UDim.new(0,10))
local MiscPadding = createPadding(Misc,UDim.new(0,10),UDim.new(0,10),UDim.new(0,10),UDim.new(0,18))
...
bloom.Text = "Bloom"
local bloomFrame = gui("Frame","Frame",buttonBackground,"Bloom",Misc,10,1)
bloomFrame.Size = UDim2.new(1,0,0,50)
local bloomControler = gui("TextBox","Input",buttonBackground,"Shaders",bloomFrame,10,frameTransparency)
bloomControler.Size = UDim2.new(0.32,0,0,40)
bloomControler.Position = UDim2.new(0,0,0,5)
...
local bloomControler1 = gui("TextBox","Input",buttonBackground,"Shaders",bloomFrame,10,frameTransparency)
bloomControler1.Size = UDim2.new(0.32,0,0,40)
bloomControler1.Position = UDim2.new(0.33,0,0,5)
...
local bloomControler2 = gui("TextBox","Input",buttonBackground,"Shaders",bloomFrame,10,frameTransparency)
bloomControler2.Size = UDim2.new(0.32,0,0,40)
bloomControler2.Position = UDim2.new(0.66,0,0,5)
bloomControler2.ClearTextOnFocus = false
bloomControler2.Text = ""
bloomControler2.PlaceholderText = "Treshold"
...
local atmosphereFrame = gui("Frame","Button",buttonBackground,"Apply",Misc,10,1)
atmosphereFrame.Size = UDim2.new(1,0,0,90)
local atmosphereControler = gui("TextBox","Input",buttonBackground,"Atmosphere",atmosphereFrame,10,frameTransparency)
atmosphereControler.Size = UDim2.new(0.32,0,0,40)
atmosphereControler.Position = UDim2.new(0,0,0,5)
...
local atmosphereControler1 = gui("TextBox","Input",buttonBackground,"Atmosphere",atmosphereFrame,10,frameTransparency)
atmosphereControler1.Size = UDim2.new(0.32,0,0,40)
atmosphereControler1.Position = UDim2.new(0.33,0,0,5)
...
local atmosphereControler2 = gui("TextBox","Input",buttonBackground,"Atmosphere",atmosphereFrame,10,frameTransparency)
atmosphereControler2.Size = UDim2.new(0.32,0,0,40)
atmosphereControler2.Position = UDim2.new(0.66,0,0,5)
...
local atmosphereControler3 = gui("TextBox","Input",buttonBackground,"Atmosphere",atmosphereFrame,10,frameTransparency)
atmosphereControler3.Size = UDim2.new(0.32,0,0,40)
atmosphereControler3.Position = UDim2.new(0.33,0,0,50)
...
local athmosphereControler4 = gui("TextBox","Input",buttonBackground,"Atmosphere",atmosphereFrame,10,frameTransparency)
athmosphereControler4.Size = UDim2.new(0.32,0,0,40)
athmosphereControler4.Position = UDim2.new(0.66,0,0,50)
...
local athmosphereControler5 = gui("TextBox","Input",buttonBackground,"Atmosphere",atmosphereFrame,10,frameTransparency)
athmosphereControler5.Size = UDim2.new(0.32,0,0,40)
athmosphereControler5.Position = UDim2.new(0,0,0,50)
...
local function getTags(tag,data,atribut) 
	local tags = data:match("<"..tag.."%s(.-)>") 
	if tags then 
		print(tags) 
		return tags
	end 
...
skybutton.MouseButton1Click:Connect(function()
	...
	skys.SkyboxBk = "rbxassetid://"..(getTags("Back",data) or "126569944133822")
	skys.SkyboxDn = "rbxassetid://"..(getTags("Down",data) or "126569944133822")
	skys.SkyboxFt = "rbxassetid://"..(getTags("Front",data) or "126569944133822")
	skys.SkyboxLf = "rbxassetid://"..(getTags("Left",data) or "126569944133822")
	skys.SkyboxRt = "rbxassetid://"..(getTags("Right",data) or "126569944133822")
	skys.SkyboxUp = "rbxassetid://"..(getTags("Up",data) or "126569944133822")
	skys.SunTextureId = "rbxassetid://"..(getTags("Sun",data) or "126569944133822")
	skys.MoonTextureId = "rbxassetid://"..(getTags("Moon",data) or "126569944133822")
	skys.StarCount = tonumber(getTags("StarCount",data)) or 10
	skys.SunAngularSize = tonumber(getTags("SunSize",data)) or 20
	skys.MoonAngularSize = tonumber(getTags("MoonSize",data)) or 20
end)
--============================================================================================================
-- settings
--============================================================================================================
...
--Config
----------------------------------------------------------------------------------------------------------------
local Config = gui("ScrollingFrame","Config",buttonBackground,"Config",rightPanel,10,1)
Config.Size = UDim2.new(1,0,1,0)
Config.CanvasSize = UDim2.new(0, 0, 0, 1000)
Config.ScrollBarThickness = 8
Config.Position = UDim2.new(0,0,0,0)
Config.Visible = false
local ConfigLayout = createLayout(KeyBind,UDim.new(0,10))
local ConfigPadding = createPadding(KeyBind,UDim.new(0,10),UDim.new(0,10),UDim.new(0,10),UDim.new(0,18))
local configTabl = {
	WebHook = "",
	Avatar = "",
	CustomSky = "",
...
local WebHook = gui("Frame","WebHook",buttonBackground,"WebHook",KeyBind,10,frameTransparency)
WebHook.Size = UDim2.new(1,0,0,40)

local WebHookInput = gui("TextBox","WebHookInput",buttonBackground,"Web Hook URL..",AntiFling,10,0.1)
WebHookInput.Size = UDim2.new(0.3,0,0,35)
WebHookInput.Position = UDim2.new(0.6,0,0,2.5)
WebHookInput.TextColor3 = textColor
WebHookInput.Text = ""

local WebHookText = gui("TextLabel","WebHookText",mainBackground,"Web Hook",AntiFling,10,1)
WebHookText.Size = UDim2.new(0.5,0,0,40)
WebHookText.Position = UDim2.new(0.02,0,0,0)
WebHookText.TextSize = 100
WebHookText.TextXAlignment = Enum.TextXAlignment.Left

local SaveConfig = gui("Frame","SaveConfig",buttonBackground,"SaveConfig",KeyBind,10,frameTransparency)
SaveConfig.Size = UDim2.new(1,0,0,40)

local SaveConfigInput = gui("TextBox","FCinput",buttonBackground,"Key Code..",AntiFling,10,0.1)
SaveConfigInput.Size = UDim2.new(0.3,0,0,35)
SaveConfigInput.Position = UDim2.new(0.6,0,0,2.5)
SaveConfigInput.TextColor3 = textColor
SaveConfigInput.Text = ""

local SaveConfigText = gui("TextLabel","Anchor Key",mainBackground,"Anchored",AntiFling,10,1)
SaveConfigText.Size = UDim2.new(0.5,0,0,40)
SaveConfigText.Position = UDim2.new(0.02,0,0,0)
SaveConfigText.TextSize = 100
SaveConfigText.TextXAlignment = Enum.TextXAlignment.Left
---------------------------------------------------------------------------------------------------------
--KeyCode
----------------------------------------------------------------------------------------------------------------
-- FC
...
local closeacceptborder = border("border",buttonBackground,4,closeaccept)
local closeOk = gui("TextButton","Close",buttonBackground,"Ok",closeaccept,10,0)
local closeCancel = gui("TextButton","Cancel",buttonBackground,"Cancel",closeaccept,10,0)
